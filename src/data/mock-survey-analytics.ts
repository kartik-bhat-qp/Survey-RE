...
> = {
  ...
  analysis: {
    ...
    items: [
      ...
      { id: 'trend-dashboard', label: 'Trend Dashboard' },
      { id: 'crosstab', label: 'Cross-Tabulation' },
      { id: 'correlation-analysis', label: 'Correlation Analysis' },
      { id: 'turf-analysis', label: 'TURF Analysis' },
      { id: 'gap-analysis', label: 'GAP Analysis' },
      { id: 'survey-comparison', label: 'Survey Comparison' },
      { id: 'consolidate-report', label: 'Consolidate Report' },
      { id: 'tubepulse', label: 'TubePulse' },
      { id: 'heatmap-analysis', label: 'HeatMap Analysis' },
      { id: 'hotspot-analysis', label: 'HotSpot Analysis' },
      { id: 'device-audit', label: 'Device Audit' },
      { id: 'conjoint-analysis', label: 'Conjoint Analysis' },
      { id: 'maxdiff-analysis', label: 'MaxDiff Analysis' },
