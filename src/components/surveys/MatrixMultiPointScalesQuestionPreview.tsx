...
import type { MatrixMultiPointPreviewData } from '@/data/mock-add-question-previews';
import styles from './MatrixMultiPointScalesQuestionPreview.module.css';

interface MatrixMultiPointScalesQuestionPreviewProps {
  data: MatrixMultiPointPreviewData;
}

export function MatrixMultiPointScalesQuestionPreview({
  data,
}: MatrixMultiPointScalesQuestionPreviewProps) {
  return (
