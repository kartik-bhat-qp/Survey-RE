...
import { DragDropMatrixPreview } from '@/components/surveys/DragDropMatrixPreview';
...
export interface DragDropQuestionRowProps {
...
export function DragDropQuestionRow({
  question,
  matrix,
  sectionId,
