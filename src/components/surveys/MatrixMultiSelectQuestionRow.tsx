...
import styles from './MatrixMultiSelectQuestionRow.module.css';

function stopQuestionEvent(event: SyntheticEvent): void {
  event.stopPropagation();
}

export interface MatrixMultiSelectQuestionRowProps {
...
export function MatrixMultiSelectQuestionRow({
  question,
  matrix,
  sectionId,
